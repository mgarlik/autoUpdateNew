  ...
  differentialDownloadInstaller(fileInfo, downloadUpdateOptions, installerPath, requestHeaders, provider) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      try {
        ...
        const oldBlockMapUrl = (0, _main().newUrlFromBase)(`${fileInfo.url.pathname.replace(new RegExp(downloadUpdateOptions.updateInfo.version, "g"), _this4.currentVersion.version)}.blockmap`, fileInfo.url);
        ...
        const downloadBlockMap = (() => {
          var _ref2 = (0, _bluebirdLst().coroutine)(function* (url) {
            ...
            const data = yield _this4.httpExecutor.request(requestOptions, downloadUpdateOptions.cancellationToken);
